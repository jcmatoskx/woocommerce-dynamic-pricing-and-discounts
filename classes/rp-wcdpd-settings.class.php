...
class RP_WCDPD_Settings
{
    ...
    public static function get_structure()
    {
        if (self::$structure === null) {
                        ...
                        'product_pricing_settings' => array(
                            ...
                            'children' => array(
                                ...
                                'product_pricing_irrational_price_handling' => array(
                                    'title'     => __('Irrational price handling', 'rp_wcdpd'),
                                    'type'      => 'select',
                                    ...
                                    'hint'      => __('For example, a <strong>3 for $10</strong> rule results in a per-item price of <strong>$3.33(3)</strong>. The first option gives a correct calculation: <strong>$3.33 * 3 = $9.99</strong>. The second option gives a desired subtotal: <strong>$3.33 * 3 = $10.00</strong>.', 'rp_wcdpd'),
                                ),
            ...
            if (wc_tax_enabled() && (!RightPress_Helper::wc_version_gte('2.5') || RP_WCDPD_Helper::wc_has_multiple_tax_classes())) {
    ...
    public function print_field_text($args = array(), $field_type = null)
    {
        ...
        // Print field
        RightPress_Form::$field_type($config);
    }
    ...
    public function print_field_textarea($args = array())
    {
        ...
        // Print field
        RightPress_Form::textarea($config);
    }
    ...
    public function print_field_checkbox($args = array())
    {
        ...
        // Print field
        RightPress_Form::checkbox(array(
            'id'                    => $prefixed_key,
            'name'                  => 'rp_wcdpd_settings[' . $prefixed_key . ']',
    ...
    public static function validate_rules($rule_type, $input)
    {
        ...
        if (!empty($input[$rule_type]) && is_array($input[$rule_type])) {
            ...
            foreach ($input[$rule_type] as $posted) {
                ...
                // Public description
                if (isset($posted['public_note']) && !RightPress_Helper::is_empty($posted['public_note'])) {
    ...
    public function export()
    {
        ...
        $data = array(
            'settings'  => $settings,
            'timestamp' => time(),
            'checksum'  => RightPress_Helper::get_hash(false, $settings),
        );
    ...
    public function import()
    {
        try {
            ...
            if ($data['checksum'] !== RightPress_Helper::get_hash(false, $data['settings'])) {
                throw new Exception;
            }
