...
class RP_WCDPD_Cart_Discounts
{
    ...
    public static function get_coupon_data_array($data)
    {
        ...
        return apply_filters('rp_wcdpd_cart_discount_coupon_data', array_merge(array(
            ...
            'usage_limit'                   => (RightPress_Helper::wc_version_gte('3.0') ? 0 : ''),
            'usage_limit_per_user'          => (RightPress_Helper::wc_version_gte('3.0') ? 0 : ''),
            'limit_usage_to_x_items'        => (RightPress_Helper::wc_version_gte('3.0') ? null : ''),
            'usage_count'                   => (RightPress_Helper::wc_version_gte('3.0') ? 0 : ''),
            'expiry_date'                   => '',
