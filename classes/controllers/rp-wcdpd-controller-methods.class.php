...
abstract class RP_WCDPD_Controller_Methods extends RP_WCDPD_Controller
{
    ...
    public function maybe_add_public_description($html, $rule_uids)
    {
        ...
        if ($descriptions = RP_WCDPD_Rules::get_public_descriptions($this->context, $rule_uids)) {
          ...
          /* Change code details - 2018 */  
            $html = '<p style="color:red">'. htmlspecialchars(json_encode($descriptions)) . '<br>' . $html . '</p>';
            ...
            if (!defined('RP_WCDPD_PUBLIC_DESCRIPTION_ASSETS_ENQUEUED')) {
                ...
                RightPress_Helper::enqueue_or_inject_stylesheet('rp-wcdpd-public-descriptions-scripts', RP_WCDPD_PLUGIN_URL . '/assets/css/public-descriptions.css', RP_WCDPD_VERSION);
